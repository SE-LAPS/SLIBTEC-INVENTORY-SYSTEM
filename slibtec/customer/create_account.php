                ...
                <div class="header-body text-center mb-7">
                    <div class="row justify-content-center">
                        <div class="col-lg-5 col-md-6">
                            < <h1 class="text-white">SLIBTEC - Sri Lanka Institute of Biotechnology<br>User Login</h1>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <form method="post" role="form">
                                ...
                                <div class="text-center">
                                    <button type="submit" name="login" class="btn btn-warning btn-lg  my-4" style="width: 350px;" >Log In</button>
                                     <button type="submit" name="addCustomer" class="btn btn-success pull-right my-1" style="width: 350px;">Create Account</button>
                                    </div>
                                </div>
                            </form>
