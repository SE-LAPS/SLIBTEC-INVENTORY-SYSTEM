...
<?php
$hrd_id = $_SESSION['hrd_id'];
//$login_id = $_SESSION['login_id'];/////////Side-bar changed///////////////
$ret = "SELECT * FROM  rpos_hr  WHERE hrd_id = '$hrd_id'";
$stmt = $mysqli->prepare($ret);
$stmt->execute();
$res = $stmt->get_result();
while ($hr = $res->fetch_object()) {
   ...
   <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light custom-navbar" id="sidenav-main">
    <div class="container-fluid">
      ...
      <a class="navbar-brand pt-0" href="dashboard.php">
        <img src="../hr/assets/theme/Logo.png" class="navbar-brand-img" alt="...">
      </a>
      <!-- User -->
      ...
      <div class="collapse navbar-collapse" id="sidenav-collapse-main">
          ...
          <div class="row">
            <div class="col-6 collapse-brand">
              <a href="dashboard.php">
                <img src="../hr/assets/img/brand/2.png">
              </a>
            </div>
        ...
        <div class="dropdown-container" aria-labelledby="storesDropdown">
          <a class="nav-link" href="change_profile.php" style="color: #fff;"><i class="fas fa-dolly-flatbed text-primary"></i>Profile</a>
            <a class="nav-link" href="personal.php" style="color: #fff;"><i class="fas fa-exclamation-triangle text-primary"></i>Personal Details</a>      
             <a class="nav-link" href="job.php" style="color: #fff;"><i class="fas fa-exclamation-triangle text-primary"></i>Job Details</a> 
        </li>

          
          <li class="nav-item">
            <a class="nav-link" href="leave.php"  style="color: #fff;">
              <i class="fas fa-users text-primary"></i> Leave & Attendance
            </a>
          </li>        
          <li class="nav-item">
            <a class="nav-link" href="payment1.php"  style="color: #fff;">
              <i class="ni ni-credit-card text-primary"></i> Performance Management
            </a>
          </li>
           <li class="nav-item">
            <a class="nav-link" href="Training & Development.php"  style="color: #fff;">
              <i class="ni ni-credit-card text-primary"></i> Training & Development
            </a>
          </li>         
           <li class="nav-item">
            <a class="nav-link" href="payment1.php"  style="color: #fff;">
              <i class="ni ni-credit-card text-primary"></i> Work Roaster
            </a>
          </li>
        </ul>
        <!-- Divider -->
        ...
        <ul class="navbar-nav mb-md-3">
          <li class="nav-item">
          <a class="nav-link" href="calender.php" style="color: #fff;">
          <i class="fas fa-hand-holding-heart yellow-icon"></i> Moment Calender      
          </a>
        </li>
