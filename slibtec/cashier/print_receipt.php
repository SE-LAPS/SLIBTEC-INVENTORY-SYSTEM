                ...
                <div id="Receipt" class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
                    <div class="row">
                        <div class="col-xs-6 col-sm-6 col-md-6">
                             <img src="../admin/assets/img/brand/Logo.png" alt="Logo" style="max-width: 50%; height: auto;">
                            
                           <address>
                                <strong>Srilanka Institute Of Biotechnology</strong>
                                <br>
                               10206
                                <br>
                                SLIBTEC Phase I Building
                                Mahenwatte Thalagala Road Pitipana
                                Homagama 
                                 Sri Lanka
                                <br>
                                +94 11 3431844
