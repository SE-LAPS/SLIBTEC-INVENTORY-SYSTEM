...
<body>
    ...
    <div class="main-content">
        ...
        ?>
            <!-- Header -->
            <div class="header pb-8 pt-5 pt-lg-8 d-flex align-items-center" style="min-height: 600px; background-image: url(../admin/assets/img/theme/bk1.jpg); background-size: cover; background-position: center top;">
                <!-- Mask -->
