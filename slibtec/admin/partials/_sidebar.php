...
.navbar-nav .nav-link {
  ...
  font-family: 'Open Sans'; /* Replace 'Your Font Family' with the desired font */
}
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="customes.php" style="color: #fff;">
              <i class="fas fa-users text-primary"></i> Registered Members
            </a>
          </li>
      ...
      <li class="nav-item">
        ...
        <div class="dropdown-container" aria-labelledby="storesDropdown">
          ...
          <li class="nav-item">
           ...
           <li class="nav-item">
            <a class="nav-link" href="boardroom.php" style="color: #fff;">
              <i class="fas fa-chart-line text-primary"></i> Board meeting Schedule
            </a>
          </li>
      </ul>
