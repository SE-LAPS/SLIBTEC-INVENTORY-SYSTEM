            ...
            <div class="col-xl-3 col-lg-6">
              <div class="card card-stats mb-4 mb-xl-0">
                <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="card-title text-uppercase text-muted mb-0">Staff Members</h5>
          ...
          <div class="card shadow">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Issued Records</h3>
                </div>
              ...
              <table class="table table-bordered">
                ...
                <thead class="thead-light">
                  <tr>
                    ...
                    <th class="text-success" scope="col"><b>Product Description</b></th>
                    ...
                    <th class="text-success" scope="col"><b>Date & Time</b></th>
                  </tr>
                </thead>
                <tbody>
                  <?php
            ...
            <div class="table-responsive">
              ...
              <table class="table table-bordered">
                <thead class="thead-light">
                  <tr>
                    <th class="text-success" scope="col"><b>Product Description</b></th>
                     <th class="text-success" scope="col"><b>Product Type</b></th>
