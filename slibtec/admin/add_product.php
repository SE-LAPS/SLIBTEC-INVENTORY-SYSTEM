...
if (isset($_POST['addProduct'])) {
    ...
    $postQuery = "INSERT INTO rpos_products (prod_id, prod_code, prod_name, prod_img, prod_qr, prod_desc, prod_price, prod_location, prod_Exp_Date, prod_GINQty) VALUES(?,?,?,?,?,?,?,?,?,?)";
    $postStmt = $mysqli->prepare($postQuery);

    // Update the bind_param to include all 11 placeholders
    $rc = $postStmt->bind_param('ssssssssss', $prod_id, $prod_code, $prod_name, $prod_img, $prod_qr, $prod_desc, $prod_price, $prod_location, $prod_Exp_Date, $prod_GINQty);
