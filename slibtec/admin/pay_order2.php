...
if (isset($_POST['pay'])) {
  ...
  if (empty($_POST["pay_code"]) || empty($_POST["pay_amt"]) || empty($_POST['pay_method'])) {
    ...
    $upQry = "UPDATE rpos_orders2 SET order_status =? WHERE order_code =?";
...
<body>
  ...
  <div class="main-content">
    ...
    $order_code = $_GET['order_code'];
    $ret = "SELECT * FROM  rpos_orders2 WHERE order_code ='$order_code' ";
              ...
              <form method="POST"  enctype="multipart/form-data">
                <div class="form-row">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" name="pay_code" value="<?php  ?>" class="form-control" value="">
                ...
                <div class="form-row">
                  <div class="col-md-6">
                    <input type="submit" name="pay" value="Request Order" class="btn btn-success" value="">
                  </div>
                </div>
              </form>
            </div>
